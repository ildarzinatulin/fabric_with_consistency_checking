...
func (x *AttestationCheckingParameters) Reset() {
	*x = AttestationCheckingParameters{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_configuration_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AttestationCheckingParameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestationCheckingParameters) ProtoMessage() {}

func (x *AttestationCheckingParameters) ProtoReflect() protoreflect.Message {
	mi := &file_common_configuration_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestationCheckingParameters.ProtoReflect.Descriptor instead.
func (*AttestationCheckingParameters) Descriptor() ([]byte, []int) {
	return file_common_configuration_proto_rawDescGZIP(), []int{8}
}

func (x *AttestationCheckingParameters) GetEnableChecking() bool {
	if x != nil {
		return x.EnableChecking
	}
	return false
}

func (x *AttestationCheckingParameters) GetRequiredNumberOfMessages() uint32 {
	if x != nil {
		return x.RequiredNumberOfMessages
	}
	return 0
}

func (x *AttestationCheckingParameters) GetFrequency() uint32 {
	if x != nil {
		return x.Frequency
	}
	return 0
...
var file_common_configuration_proto_rawDesc = []byte{
	...
	,
	...
	0x0d, 0x52, 0x09, 0x66, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x42, 0xa8, 0x01, 0x0a,
...
var file_common_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_common_configuration_proto_goTypes = []interface{}{
	...
	(*AttestationCheckingParameters)(nil), // 8: common.AttestationCheckingParameters
	nil,                                   // 9: common.Capabilities.CapabilitiesEntry
}
var file_common_configuration_proto_depIdxs = []int32{
	3, // 0: common.Orderers.consenter_mapping:type_name -> common.Consenter
	9, // 1: common.Capabilities.capabilities:type_name -> common.Capabilities.CapabilitiesEntry
...
func file_common_configuration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_configuration_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AttestationCheckingParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
