...
type mockConstructorTestingTNewChannelResources interface {
	mock.TestingT
	Cleanup(func())
}

// NewChannelResources creates a new instance of ChannelResources. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewChannelResources(t mockConstructorTestingTNewChannelResources) *ChannelResources {
	mock := &ChannelResources{}
	mock.Mock.Test(t)
