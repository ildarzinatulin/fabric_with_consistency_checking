...
import (
	...
	pcomm "github.com/ildarzinatulin/fabric-protos-go/common"
...
func newPeerNodeWithGossipWithValidatorWithMetrics(logger gossiputil.Logger, id int, committer committer.Committer,
	...
	}, &transientstore.Store{}, protoutil.SignedData{}, gossipMetrics.PrivdataMetrics, coordConfig, nil, nil, nil)
